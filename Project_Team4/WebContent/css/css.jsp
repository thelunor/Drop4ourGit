<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/fonticons.css">
	...
	<script src="<%=request.getContextPath() %>/assets/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
