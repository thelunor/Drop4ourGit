...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0d0c0a21e3bf46994d7f7a41d9cc729f&libraries=services"></script>
   <script type="text/javascript">
	        $(function () {
	        	...
	        	//console.log(aptNameValue);
	        	for(var i=0; i< aptNameValue.length; i++){                          
	        		aptNameArr[i] = $("input[name='aptName']")[i].value;
	            }
		    ...
		    <div class="row">
		        ...
		        <div class="col-lg-4">
		            <div class="detail" style="text-align: center;">
		                <input type="text" class="form-control" name="aptName" value="${sale.key.aptName}">
