...
<body>
	...
	<div class="container">
		...
		<div class="content" style="text-align: left;">
			...
			<br>
			<br>
			<span style="font-size: 18px;">소재지 &nbsp;&nbsp;&nbsp;</span> <input type="text" placeholder="내용을 입력해주세요." style="width: 663px; height: 30px; font-family: 26px; text-align: left;">
			<br>
			<br>
			...
			<table border="1" style="width: 100%; text-align: left; font-size: 14px;"  >
				<tr ><td style="text-align: center;">매매대금</td><td style="text-align: center; ">一金</td><td><input type="text" name="#" style="width: 250px" placeholder="10,000">원정 (\&nbsp;<input type="text" name="#" style="width: 150px" placeholder="100,000,000">)
				<tr ><td style="text-align: center; ">계약금</td><td style="text-align: center; ">一金</td><td><input type="text" name="#" style="width: 250px">원정은 계약시에 지불하고 영수함. 영수자(<input type="text" placeholder="자필서명" style="width: 70px">)(인)
				...
				<tr ><td style="text-align: center; ">잔금</td><td style="text-align: center; ">一金</td><td><input type="text" name="#" style="width: 250px" placeholder="1억">원정은 &nbsp;&nbsp;<input type="text" id="jung1" style="width: 100px; text-align: right;">일에 지불한다.</td>
			</table>
			<br>
			<br>
			<span style="font-size: 14px">제 2조 [소유권이전 등] 매도인은 매매대금의 잔금 수령과 동시에 매수인에게 소유권이전 등기에 필요한 모든 서류를 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;교부하고 등기 절차에 협력하여야 하며, 위 부동산의 인도일은 <input type="text" id="jung2" style="width: 100px; text-align: right;">로 한다.</span><br>
			...
			<span style="font-size: 14px">제 9조 [중개대상물확인설명서 교부 등] 개공인중개사는 중개대상물확인설명서를 작성하고 업무보증관계증서(공제증서  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;등) 사본을 첨부하여 거래당사자 쌍방에게 교부한다. (교부일자: <input type="text" id="jung1" style="width: 100px; text-align: right;">)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset"  value="계약조항 초기화"></span><br>
			...
			<br>			
			<table border="1" style="width: 100%; text-align: left; font-size: 14px;"  >
				<tr><td rowspan="2" style="text-align: center;">매도인<br><input type="text" style="width: 80px;"></td><td>주 소(도로명)</td><td><input type="text" placeholder="도로명 주소를 모르는 경우 우측에 도로명 검색을 클릭하세요!" style="width: 460px;"><input type="button"  value="도로명 검색" ></td>
			...
			<br>
			<table border="1" style="width: 100%; text-align: left; font-size: 14px;"  >
				<tr><td rowspan="3" style="text-align: center; width: 84px;">개&nbsp;&nbsp;업<br>공인중개사</td><td style="width: 84px; font-size: 13px;">사무소 소재지</td><td colspan="3"><input type="text" style="width: 100%"></td></tr>
				<tr><td style="width: 84px; font-size: 13px">사무소 명칭</td><td colspan="1"><input type="text" style="width: 100%"></td><td style="width: 100px; text-align: center;">대표자 명</td><td  style="width: 100px; text-align: center;"><input type="text" style="width: 100%"></td></tr>
				<tr><td style="width: 84px; font-size: 13px">전화번호</td><td><input type="text" style="width: 135px">&nbsp;등록번호&nbsp;<input type="text" style="width: 137px"></td><td>소속공인중개사</td><td>(<input type="text" style="width: 90px; text-align: center;" placeholder="자필서명">)</td></tr>
			</table>
			<br>
			<br>
			<br>
			<div style="text-align: center;">
				<button class="btn btn-primary btn-lg" style="width: 180px; height: 50px; font-size: 15px;">작성 완료</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
